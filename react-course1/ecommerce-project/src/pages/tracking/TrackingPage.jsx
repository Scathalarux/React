...
import TrackingIcon from '../../../public/images/icons/tracking-favicon.png';

export function TrackingPage({ cartProducts }) {
  ...
  let isShipping = deliveryPercent >= 33 && deliveryPercent < 100;
